...
sleep(1)
# same as above but using degrees instead of rotations (3 x 360)
...
tank_pair.on_for_seconds(left_speed=40, right_speed=40, seconds=4)
sleep(1)
# equivalent to above (this is used when you want to run forever, untill some logicc says stop/off)
